...
export const GallerySection = () => {
  ...
  const allImages = portfolioData.categories.flatMap(cat => 
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12">
        <FadeIn direction="up">
          <div className="text-center mb-12">
            <h2 className="text-4xl sm:text-5xl font-serif italic text-[#c68b98] mb-4">Nuestro Trabajo</h2>
            <p className="font-sans text-lg text-[#7A6A6A] max-w-2xl mx-auto mb-10">
              Echad un ojillo a las celebraciones a las que les hemos dado vida. Aquí os dejamos algunos de nuestros montajes, pinchad en las fotos si queréis verlas de cerca.
            </p>
        ...
        <div className="columns-2 sm:columns-3 lg:columns-4 gap-4 sm:gap-6 space-y-4 sm:space-y-6">
          {filteredImages.map((img, idx) => (
            <FadeIn key={idx} delay={(idx % 4) * 0.1} direction="up" className="break-inside-avoid">
              <div 
